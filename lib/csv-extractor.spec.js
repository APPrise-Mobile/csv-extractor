...
describe('CSV Extractor', function() {
  ...
  it.only('should group the output by the specified key', function(done) {
  ...
  it('should extract emails from a csv', function(done) {
    var extractor = csvExtractor('test/email-csv', false, 1);
    extractor.extract()
      .then(function(data) {
        done();
      })
